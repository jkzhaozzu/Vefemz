...
//    fp=GetMeshPointer(unipolymesh,5);
    ...
    VEC0PkH2NC VE128(k,sms,TQ,ms128,dof128);
    PlateContactModel platecontact128(VE128);
    platecontact128.IterativeSolve();
...
//        fp=GetMeshPointer(unipolymesh,meshID);
        ...
        PlateContactModel platecontact(VE);
        platecontact.IterativeSolve();
