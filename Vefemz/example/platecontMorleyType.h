...
void platecontMorleyType()
{
 ...
 //   fp=GetMeshPointer(unipolymesh,5);
    ...
    VEMorleyType VE128(k,sms,TQ,ms128,dof128);
    PlateContactModel platecontact128(VE128,1);
    platecontact128.IterativeSolve2();
...
*/
    for(int meshID=2;meshID<7;meshID++)
    {
        ...
        PlateContactModel platecontact(VE,1);
        platecontact.IterativeSolve2();
